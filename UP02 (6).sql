...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Мар 24 2025 г., 22:13
...
--
ALTER TABLE `Lessons`
  ADD CONSTRAINT `lessons_ibfk_1` FOREIGN KEY (`DisciplineProgramId`) REFERENCES `DisciplinePrograms` (`Id`),
  ADD CONSTRAINT `lessons_ibfk_2` FOREIGN KEY (`StudGroupId`) REFERENCES `StudGroups` (`Id`);

--
-- Ограничения внешнего ключа таблицы `Marks`
--
ALTER TABLE `Marks`
  ADD CONSTRAINT `marks_ibfk_1` FOREIGN KEY (`LessonId`) REFERENCES `Lessons` (`Id`),
...
--
ALTER TABLE `StudPlan`
  ADD CONSTRAINT `studplan_ibfk_1` FOREIGN KEY (`TeachersLoadId`) REFERENCES `TeachersLoad` (`Id`);
...
--
ALTER TABLE `TeachersLoad`
  ADD CONSTRAINT `teachersload_ibfk_1` FOREIGN KEY (`TeacherId`) REFERENCES `Teachers` (`Id`),
