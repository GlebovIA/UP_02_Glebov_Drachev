...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Мар 29 2025 г., 09:40
...
(3, 3, 1, '2023-10-03 10:00:00', 5, 'Опоздание из-за транспорта'),
(4, 5, 3, '2023-10-06 13:00:00', 10, 'Опоздание');
...
CREATE TABLE `ConsultationResults` (
  ...
  `SubmittedPractice` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, 3, 3, 1, '27, 28'),
(5, 3, 4, 0, '-'),
(6, 4, 2, 1, 'Лабораторная работа 1'),
(7, 4, 5, 0, '-'),
(8, 4, 6, 1, 'Лабораторная работа 2');
...
(3, 1, '2023-10-07 14:00:00'),
(4, 2, '2023-10-08 15:00:00');
...
(1, 1, 'Алгебра', 1, 10, 0),
(2, 2, 'Механика', 2, 8, 0),
(3, 3, 'Основы программирования', 1, 15, 0),
(4, 3, 'Алгоритмы', 2, 10, 0);
...
INSERT INTO `Lessons` (`Id`, `DisciplineProgramId`, `StudGroupId`, `Time`) VALUES
(1, 1, 1, '2023-10-03 10:00:00'),
(2, 2, 2, '2023-10-04 11:00:00'),
(3, 3, 1, '2023-10-05 12:00:00'),
(4, 4, 2, '2023-10-06 13:00:00');
...
INSERT INTO `Marks` (`Id`, `Date`, `Mark`, `LessonId`, `StudentId`, `Description`) VALUES
(1, '2023-10-03 10:00:00', '5', 1, 1, 'Отличная работа'),
(2, '2023-10-03 10:00:00', '4', 1, 3, 'Хорошая работа'),
(3, '2023-10-03 10:00:00', 'н', 1, 4, 'Отсутствовал'),
(4, '2023-10-04 11:00:00', '2', 2, 2, 'Очень плохо'),
(5, '2023-10-04 11:00:00', '5', 2, 5, 'Отлично'),
(6, '2023-10-04 11:00:00', 'н', 2, 6, 'Отсутствовал');
...
(3, 'Васильев', 'Василий', 'Васильевич', 1, NULL, 6),
(4, 'Кузнецова', 'Мария', 'Ивановна', 1, NULL, 7),
(5, 'Николаев', 'Николай', 'Николаевич', 2, NULL, 8),
(6, 'Павлова', 'Елена', 'Петровна', 2, NULL, 9);
...
--
-- Дамп данных таблицы `StudPlan`
--

INSERT INTO `StudPlan` (`Id`, `TeachersLoadId`, `PastLectureHours`, `PastPracticeHours`) VALUES
(1, 1, 10, 5),
(2, 2, 8, 3),
(3, 3, 5, 2),
(4, 4, 5, 2);
...
(5, 'teacher2', 'teacher123', 2),
(6, 'student3', 'student123', 3),
(7, 'student4', 'student123', 3),
(8, 'student5', 'student123', 3),
(9, 'student6', 'student123', 3);
...
ALTER TABLE `Absences`
  ...
  ADD CONSTRAINT `absences_ibfk_2` FOREIGN KEY (`DisciplineId`) REFERENCES `Disciplines` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `Lessons`
  ADD CONSTRAINT `lessons_ibfk_1` FOREIGN KEY (`DisciplineProgramId`) REFERENCES `DisciplinePrograms` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lessons_ibfk_2` FOREIGN KEY (`StudGroupId`) REFERENCES `StudGroups` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `Marks`
--
ALTER TABLE `Marks`
  ADD CONSTRAINT `marks_ibfk_1` FOREIGN KEY (`LessonId`) REFERENCES `Lessons` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `Students`
  ...
  ADD CONSTRAINT `students_ibfk_2` FOREIGN KEY (`UserId`) REFERENCES `Users` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `StudPlan`
--
ALTER TABLE `StudPlan`
  ADD CONSTRAINT `studplan_ibfk_1` FOREIGN KEY (`TeachersLoadId`) REFERENCES `TeachersLoad` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `TeachersLoad`
  ADD CONSTRAINT `teachersload_ibfk_1` FOREIGN KEY (`TeacherId`) REFERENCES `Teachers` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
